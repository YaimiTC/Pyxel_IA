...
class PurchaseOrder(models.Model):
    ...
    bl_number = fields.Char(string='BL / AWB')

    # Cliente de esta OC en particular. Necesario cuando el proceso de
    # importación tiene varios clientes (varias OC, una por cliente) — así se
    # sabe a qué cliente corresponde cada OC sin depender de los bloques de
...
class PurchaseOrderLine(models.Model):
    ...
    # Campo intermedio de un solo salto: el dominio de product_uom no puede
