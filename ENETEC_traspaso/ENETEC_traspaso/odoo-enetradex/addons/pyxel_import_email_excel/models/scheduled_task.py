    ...
    def scheduled_check_contract_expiration(self):
        ...
        if salespersons_emails and mail_server_id:
            ...
            for contract in active_contracts:
                ...
                if partner_email:
                    message = f'El contrato ({contract_name}) firmado con ENETEC S.A. se encuentra próximo a vencerse, se le enviará el suplemento para la continuidad de los servicios con nosotros'
                    mail_values = {
